...
#compile("Harrison_SR_Analysis/R/Ricker_simple_LN_Correct.cpp",libtmb=FALSE, "-O1 -g", DLLFLAGS="")
dyn.load(dynlib("Harrison_SR_Analysis/R/Ricker_simple_LN_Correct"))

# Autocorr model
#dyn.unload(dynlib("../R/Ricker_autocorr_ch"))
#compile("Harrison_SR_Analysis/R/Ricker_autocorr_ch_LN_Correct.cpp",libtmb=FALSE, "-O1 -g", DLLFLAGS="",tracesweep = TRUE)
dyn.load(dynlib("Harrison_SR_Analysis/R/Ricker_autocorr_ch_LN_Correct"))

# TV alpha model
#dyn.unload(dynlib("Harrison SR Analysis/R/Rickerkf_ratiovar_LN_Correct"))
#compile("Harrison_SR_Analysis/R/Rickerkf_ratiovar_LN_Correct.cpp")
dyn.load(dynlib("Harrison_SR_Analysis/R/Rickerkf_ratiovar_LN_Correct"))
...
obj<-MakeADFun(mydata,parameters_simple,random=NULL,DLL="Ricker_simple_LN_Correct")
...
pm
ggsave("Harrison_SR_Analysis/Figures/posterior_simple_model_fit_LN.pdf", plot=pm, width=10,height=7)
...
write.csv(simpleparb, "Harrison_SR_Analysis/DataOut/Simple_Ricker_Ests_LN.csv")
...
objar <- MakeADFun(mydataar,parameters_autocorr,random=NULL,DLL="Ricker_autocorr_ch_LN_Correct")
...
ggsave("Harrison_SR_Analysis/Figures/posterior_ar_model_fit_LN_Correct.pdf", plot=pmar, width=10,height=7)
...
write.csv(arpar, "Harrison_SR_Analysis/DataOut/AR_Model_Ests_LN.csv")
...
obj_timevar<-MakeADFun(mydatatimevar, parameters_recursive, random="a", DLL="Rickerkf_ratiovar_LN_Correct")
...
write.csv(timevar_par, "Harrison_SR_Analysis/DataOut/TimeVar_Ests_LN.csv")
...
ggsave("Harrison_SR_Analysis/Figures/TV_Model_Posts_LN.pdf", plot=pmrb, width=10,height=7)
...
ggsave("Harrison_SR_Analysis/Figures/Residuals_by_BroodYear_LN.pdf", plot=pp, width=11,height=7)
#---------------------
# std. residuals by BY
pp <- ggplot(allfits )  +
  geom_line(aes(x=BroodYear,y=std_resids),size=1.2)  +
...
ggsave("Harrison_SR_Analysis//Figures/Std_Residuals_by_BroodYear_LN.pdf", plot=pp, width=11,height=7)
...
ggsave("Harrison_SR_Analysis/Figures/Residuals_by_Spawners_LN.pdf", plot=psp, width=11,height=7)
...
ggsave("Harrison_SR_Analysis/Figures/StdResiduals_by_Spawners_LN.pdf", plot=psp, width=11,height=7)
...
ppa 
ggsave("Harrison_SR_Analysis/Figures/Productivity_Comparison_LN.pdf", plot=ppa, width=10,height=7)
...
write.csv(AIC_Tab, "Harrison_SR_Analysis/DataOut/AICTab_LN.csv")
